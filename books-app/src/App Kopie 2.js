  ...
  render() {
    let books = this.state.books.map((book) => {
      return(
        <tr key={book.id}>
            ...
            <td>{book.rating}</td>
            <td>
              <Button color="success" size="sm" className="mr-2" onClick={this.editBook.bind(this. book.id, book.title, book.rating)}
              >Edit</Button>
    ...
    <Button className="my-3" color="primary" onClick={this.toggleNewBookModal.bind(this)}>Add Book</Button>
      ...
      <Modal isOpen={this.state.editBookModal} toggle={this.toggleEditBookModal.bind(this)}>
        <ModalHeader toggle={this.toggleEditBookModal.bind(this)}>Thank you for your purchase!</ModalHeader>
        <ModalBody>
          <FormGroup>
      ...
      <Table>
        ...
        <tbody>
          <tr>
            ...
            <td>0.24</td>
            <td>
              <Button color="success" size="sm" className="mr-2" onClick={this.toggleEditBookModal.bind(this)}
              >Buy</Button>
            </td>
          </tr>
          <tr>
            <td>2</td>
            <td>Susan Wise Bauer</td>
